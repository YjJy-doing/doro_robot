...
enum ActionState {
    ...
    kActionStateTurnLeft90,
    kActionStateTurnRight90,
    kActionStateWave,
    kActionStateSway,
    kActionStateIdleRandom,
    kActionStateStop
};
...
private:
    ...
    int clock_ticks_ = 0;
    int idle_action_countdown_s_ = 0;
    bool pending_talent_after_song_ = false;
